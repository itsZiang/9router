...
export function resolveConnectionParams(credentials) {
  ...
  if (!accessToken) {
    return {
      error: "Missing M365 Copilot access_token. Paste it as the provider credential."
    };
  }
