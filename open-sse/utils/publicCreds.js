 ...
 */
export function decodePublicCred(value) {
 ...
 */
export function encodePublicCred(plain) {
  if (!plain) return "";
 ...
 */
export function decodePublicCredBytes(bytes) {
 ...
 *   node -e 'import("./open-sse/utils/publicCreds").then(m =>
...
const EMBEDDED_DEFAULTS = {
  ...
  gemini_id: [89, 85, 95, 91, 71, 90, 77, 68, 92, 30, 73, 64, 79, 3, 6, 91, 75, 2, 3, 0, 29, 28, 13, 0, 1, 5, 77, 0, 30, 17, 4, 4, 90, 8, 21, 30, 30, 92, 11, 4, 12, 88, 65, 90, 31, 90, 4, 93, 0, 6, 76, 11, 6, 12, 74, 26, 84, 26, 30, 11, 27, 17, 0, 27, 0, 0, 67, 4, 91, 1, 3, 4],
  gemini_alt: [40, 34, 45, 58, 34, 55, 88, 64, 16, 101, 23, 56, 50, 1, 68, 82, 66, 65, 98, 4, 64, 9, 12, 36, 89, 54, 1, 80, 78, 28, 45, 36, 31, 17, 15],
  // Antigravity — google oauth client (public)
  antigravity_id: [94, 93, 89, 88, 66, 95, 67, 68, 83, 29, 69, 76, 83, 65, 29, 14, 69, 5, 66, 6, 3, 92, 1, 64, 94, 25, 23, 23, 72, 66, 70, 87, 26, 29, 12, 65, 25, 91, 7, 89, 9, 93, 66, 92, 16, 4, 75, 76, 0, 5, 17, 66, 14, 12, 66, 17, 93, 10, 24, 29, 12, 0, 12, 26, 26, 17, 72, 30, 1, 76, 15, 6, 14],
  antigravity_alt: [40, 34, 45, 58, 34, 55, 88, 63, 80, 21, 54, 34, 48, 88, 81, 85, 97, 18, 125, 37, 92, 3, 37, 48, 87, 6, 44, 38, 25, 10, 67, 19, 40, 40, 5],
  // Windsurf / Devin CLI — firebase web client identifier (public)
  windsurf_fb: [46, 36, 20, 8, 33, 22, 55, 4, 41, 121, 53, 50, 49, 24, 92, 90, 108, 35, 97, 36, 21, 44, 11, 69, 3, 60, 35, 15, 126, 53, 71, 56, 52, 56, 43, 26, 27, 86, 58],
  // Claude Code CLI — anthropic oauth client (public, PKCE)
  claude_id: [86, 9, 95, 10, 64, 90, 69, 21, 72, 72, 70, 68, 0, 65, 93, 87, 73, 79, 28, 87, 85, 11, 13, 95, 90, 76, 64, 81, 73, 65, 76, 84, 94, 15, 86, 72],
  // Codex CLI — openai oauth client (public, PKCE)
  codex_id: [14, 29, 30, 54, 55, 34, 26, 21, 8, 104, 53, 47, 85, 95, 15, 83, 110, 29, 105, 14, 53, 30, 94, 26, 29, 20, 26, 11],
  // Qwen Code CLI — qwen oauth client (public, device flow)
  qwen_id: [9, 93, 93, 89, 70, 92, 66, 71, 7, 26, 68, 20, 86, 88, 13, 81, 79, 67, 9, 91, 12, 93, 15, 16, 88, 69, 23, 4, 20, 21, 64, 84],
  // Kimi coding CLI — moonshot oauth client (public)
  kimi_id: [94, 90, 11, 92, 20, 89, 66, 69, 72, 73, 65, 76, 86, 65, 93, 7, 75, 20, 28, 86, 90, 94, 95, 95, 90, 64, 69, 83, 78, 18, 65, 90, 15, 89, 90, 21],
  ...
  grok_id: [13, 92, 15, 89, 66, 91, 76, 70, 72, 29, 71, 70, 3, 65, 93, 84, 72, 23, 28, 87, 92, 88, 15, 95, 91, 22, 71, 87, 20, 66, 67, 86, 13, 81, 81, 21]
};
/**
 ...
 */
export function resolvePublicCred(key, envName) {
  if (envName) {
 ...
 */
export function resolvePublicCredMulti(key, envNames) {
