...
import { WEB_SESSION_CREDENTIAL_REQUIREMENTS } from "../stubs/shared/providers/webSessionCredentials";
const DEFAULT_THRESHOLD_MS = 2_000;
const SLOW_THRESHOLD_MS = 15_000;
const SLOW_PROVIDER_IDS = new Set();
...
export const SLOW_KEEPALIVE_PROVIDERS = SLOW_PROVIDER_IDS;
export function resolveKeepaliveThreshold(model) {
