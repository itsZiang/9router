 ...
 */
export async function submitComfyWorkflow(baseUrl, workflow) {
 ...
 */
export async function pollComfyResult(baseUrl, promptId, timeoutMs = 120_000) {
 ...
 */
export async function fetchComfyOutput(baseUrl, filename, subfolder, type) {
 ...
 */
export function extractComfyOutputFiles(historyEntry) {
  const files = [];
