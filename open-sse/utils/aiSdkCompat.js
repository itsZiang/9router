...
export function normalizeStreamDefaultMode(value) {
 ...
 */
export function clientWantsJsonResponse(acceptHeader) {
 ...
 */
export function acceptHeaderForcesStream(acceptHeader, bodyStream) {
 ...
 */
export function resolveStreamFlag(bodyStream, acceptHeader, sourceFormat, optionsOrUserAgent) {
...
export function isKnownJsonOnlyClient(userAgent) {
 ...
 */
export function resolveExplicitStreamAlias(body) {
 ...
 */
export function hasExplicitNoStreamParam(body) {
