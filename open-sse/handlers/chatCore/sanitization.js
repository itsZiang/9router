...
export function sanitizeChatRequestBody(body, sourceFormat, targetFormat) {
  const prefersResponsesTokenField = sourceFormat === FORMATS.OPENAI_RESPONSES || targetFormat === FORMATS.OPENAI_RESPONSES;
  ...
  if (Array.isArray(body.tools)) {
    ...
    body.tools = body.tools.map(tool => sanitizeOpenAITool(tool));
  }
  return body;
}