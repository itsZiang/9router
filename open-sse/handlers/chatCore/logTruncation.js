import { getChatLogTextLimit, getChatLogMaxDepth, getChatLogArrayTailItems, getChatLogMaxObjectKeys } from "../../stubs/lib/logEnv";
import { estimateSizeFast } from "../../utils/estimateSize";
...
export function cloneBoundedChatLogPayload(value, depth = 0) {
...
export function truncateForLog(value) {
  ...
  if (estimatedSize <= MAX_LOG_BODY_CHARS) return value;
