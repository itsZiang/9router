export function getHeaderValueCaseInsensitive(headers, targetName) {
 ...
 */
export function isNoMemoryRequested(headers) {
 ...
 */
export function resolveCompressionHeader(headers) {
 ...
 */
export function isStripReasoningRequested(headers) {
