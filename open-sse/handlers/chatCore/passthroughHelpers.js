 ...
 */
export function redactPassthroughThinkingSignatures(messages, _signature) {
  return messages;
}
export function isClaudeCodeSemanticPassthroughRequest({
  ...
  const isDirectClaudeCodeProvider = provider === "claude" || isClaudeCodeCompatibleProvider(provider);
