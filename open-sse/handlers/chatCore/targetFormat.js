...
import { PROVIDER_ID_TO_ALIAS, getModelTargetFormat } from "../../config/providerModels";
import { getTargetFormat } from "../../services/provider";
...
export function resolveChatCoreTargetFormat(opts) {
  ...
  const targetFormat = apiFormat === "responses" ? FORMATS.OPENAI_RESPONSES : modelTargetFormat || customModelTargetFormat || getTargetFormat(provider, providerSpecificData);
  return {
    alias,
    targetFormat
  };
