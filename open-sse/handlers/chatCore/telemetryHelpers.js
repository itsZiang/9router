import { fetchLiveProviderLimits } from "../../stubs/lib/usage/providerLimits";
import { isClaudeExtraUsageBlockEnabled } from "../../stubs/lib/providers/claudeExtraUsage";
...
export function __resetLiveWsForwardingState() {
  liveWsConsecutiveFailures = 0;
  liveWsDisabledUntil = 0;
}
export async function forwardDashboardEventToLiveWs(event, payload, fetchImpl = fetch, now = Date.now) {
