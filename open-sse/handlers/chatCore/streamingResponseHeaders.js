...
import { buildStreamingResponseHeaders as defaultBuildStreaming } from "./responseHeaders";
export function assembleStreamingResponseHeaders(args, buildStreamingResponseHeaders = defaultBuildStreaming) {
