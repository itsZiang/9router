...
import { findWorkingProxy, clearProxyFallbackCache } from "../utils/proxyFallback";
 ...
 */
export async function selectProxyForValidation(targetUrl) {
 ...
 */
export function clearProxySelectionCache() {
