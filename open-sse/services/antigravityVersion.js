const ANTIGRAVITY_RELEASE_FEED_URL = "https://antigravity-auto-updater-974169037036.us-central1.run.app/releases";
const ANTIGRAVITY_GITHUB_RELEASE_URL = "https://api.github.com/repos/antigravityide/antigravity/releases/latest";
...
function pickNewestVersion(...versions) {
  return versions.map(version => normalizeVersion(version)).filter(version => !!version).reduce((best, version) => compareSemver(version, best) > 0 ? version : best, ANTIGRAVITY_FALLBACK_VERSION);
}
