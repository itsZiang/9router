 ...
 */
export const LEGACY_FREE_PROVIDERS = ["kiro", "qoder", "pollinations", "longcat", "cloudflare-ai", "qwen", "nvidia-nim", "cerebras", "groq"];
 ...
 */
export function deriveNoAuthFreeProviders() {
  try {
    const ids = [];
...
export function mergeTierConfig(userConfig) {
  ...
  return {
    ...
    providerOverrides: [...DEFAULT_TIER_CONFIG.providerOverrides, ...(userConfig.providerOverrides || [])],
    modelOverrides: [...DEFAULT_TIER_CONFIG.modelOverrides, ...(userConfig.modelOverrides || [])],
    freeProviders: [...new Set([...DEFAULT_TIER_CONFIG.freeProviders, ...(userConfig.freeProviders || [])])]
  };
}