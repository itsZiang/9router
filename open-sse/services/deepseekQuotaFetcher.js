 ...
 */
export async function fetchDeepseekQuota(connectionId, connection) {
  // Check cache first
 ...
 */
export function invalidateDeepseekQuotaCache(connectionId) {
  quotaCache.delete(connectionId);
}
 ...
 */
export function registerDeepseekQuotaFetcher() {
