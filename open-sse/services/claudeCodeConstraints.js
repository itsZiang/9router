 ...
 * invariant).
 */
export function enforceThinkingTemperature(body) {
...
export function disableThinkingIfToolChoiceForced(body) {
...
export function enforceCacheControlLimit(body) {
  let count = 0;
...
export function ensureCacheControlOnLastUserMessage(body) {
  const messages = body.messages;
