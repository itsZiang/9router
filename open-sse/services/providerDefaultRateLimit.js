...
export function __setProviderDefaultRateLimitsForTests(map) {
  providerDefaultOverrides = map;
  limiter.reset();
}
export function getProviderDefaultRateLimit(provider) {
 ...
 */
export function acquireProviderDefaultSlot(provider, connectionId) {
