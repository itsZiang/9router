...
export function analyzeSpecificity(input) {
...
export function getSpecificityLevel(score) {
...
export function getRecommendedMinTier(level) {
  switch (level) {
    case "trivial":
      return "free";
    case "simple":
...
export function isHighSpecificity(result) {
  return result.score >= 50;
}
export function isLowSpecificity(result) {
