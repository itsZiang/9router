...
const BROWSER_KEYWORDS = ["browser", "playwright", "puppeteer", "screenshot", "navigate", "click", "form", "page", "tab", "window", "computer_use", "computer-use"];

// Keywords that signal high complexity
const HIGH_COMPLEXITY_KEYWORDS = ["deploy", "migration", "security", "auth", "database", "refactor", "production", "incident"];
 ...
 */
export function detectVolumeSignals(body) {
 ...
 */
export async function recommendStrategyOverride(signals, currentStrategy) {
  const noOverride = {
