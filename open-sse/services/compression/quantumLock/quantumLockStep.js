import { detectVolatileSpans } from "./quantumLock";
import { placeholderFor, TAIL_DELIM } from "./quantumPatterns";
 ...
 */
export function applyQuantumLock(body, cfg, _ctx) {
  ...
  if (text.includes(TAIL_DELIM)) return {
    body,
    stats: emptyStats()
  }; // idempotency
