...
export const DEFAULT_PREFIX_FREEZE = {
  enabled: false,
  threshold: 3
};
...
export function resolvePrefixFreezeConfig(env = process.env) {
  return {
    enabled: env.COMPRESSION_PREFIX_FREEZE_ENABLED === "true",
    threshold: toPositiveInt(env.COMPRESSION_PREFIX_FREEZE_THRESHOLD, DEFAULT_PREFIX_FREEZE.threshold)
  };
}
 ...
 */
export function extractStablePrefixHash(body) {
