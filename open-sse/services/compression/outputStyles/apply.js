import { SHARED_BOUNDARIES, shouldBypassCavemanOutputMode } from "../outputMode";
import { OUTPUT_STYLE_IDS, outputStyleMeta } from "./catalog";
 ...
 */
export function applyOutputStyles(body, selection, language = "en") {
  ...
  const alreadyApplied = messages.some(message => message.role === "system" && typeof message.content === "string" && message.content.includes(OUTPUT_STYLE_MARKER));
