import { collapseRepeated } from "./collapseRepeated";
import { MCP_ACCESSIBILITY_TAIL_RESERVE } from "./constants";
...
export function smartFilterText(text, config) {
  ...
  out = collapseRepeated(out, config.collapseThreshold, config.collapseKeepHead, config.collapseKeepTail);
...
export { DEFAULT_MCP_ACCESSIBILITY_CONFIG, clampMcpAccessibilityConfig, MCP_ACCESSIBILITY_TAIL_RESERVE } from "./constants";