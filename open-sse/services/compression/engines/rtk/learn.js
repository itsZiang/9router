...
import { discoverRepeatedNoise, discoverNormalizeLine } from "./discover";
 ...
 */
export function commandToId(command) {
 ...
 */
export function suggestFilter(command, samples) {
  ...
  if (totalSamples === 0) {
    return {
      ...
      _meta: {
        ...
        dropThreshold: DROP_THRESHOLD_RATIO
      }
    };
  }
