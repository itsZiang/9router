import { z } from "zod";
const rtkFilterCategorySchema = z.enum(["git", "test", "build", "shell", "docker", "package", "infra", "cloud", "generic"]);
