 ...
 */
import { parseScalar, parseQuotedString, splitRespectingQuotes, splitFieldDecl, MISSING, ATTACHMENT } from "./scalar";
...
export function decodeGeneric(input) {
  ...
  if (profile !== "generic") throw new Error(`unsupported_profile: ${profile} (only generic profile is supported in this vendored build)`);
