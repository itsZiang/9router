...
import { encodeGeneric, decodeGeneric } from "./gcf/index";
import { TOON_FENCE_OPEN, decodeToon } from "./toon";
 ...
 */
export function encodeGcfBlock(arr) {
 ...
 */
export function wrapGcf(blockContent) {
 ...
 */
export function encodeTabular(arr) {
 ...
 */
export function encodeTabularBlock(arr) {
 ...
 */
export function wrapTabular(blockContent) {
 ...
 */
export function encodeTabularBlockLegacy(arr) {
 ...
 */
export function decodeTabularBlockLegacy(block) {
 ...
 */
export function decodeTabular(text) {
