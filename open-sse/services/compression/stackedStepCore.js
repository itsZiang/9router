...
export function createStackAccumulator() {
  return {
    techniques: new Set(),
    rules: new Set(),
    breakdown: [],
 ...
 */
export function decideStep(result, bailout) {
...
export function mergeStackStep(acc, engineId, result) {
  ...
  acc.breakdown.push({
    ...
    ...(result.stats.durationMs !== undefined ? {
