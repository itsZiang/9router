 ...
 */
export function setCustomAliases(aliases) {
  _aliasStore[CUSTOM_ALIASES_GLOBAL_KEY] = {
    ...aliases
  };
}
 ...
 */
export function getCustomAliases() {
  return {
    ...customAliases()
  };
}
 ...
 */
export function getDeprecationNotice(modelId) {
 ...
 * Add a custom alias.
 */
export function addCustomAlias(from, to) {
 ...
 */
export function removeCustomAlias(from) {
  const custom = customAliases();
  if (custom[from]) {
    delete custom[from];
    return true;
