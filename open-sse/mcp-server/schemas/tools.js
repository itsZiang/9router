...
import { AUTO_ROUTING_STRATEGY_VALUES, ROUTING_STRATEGY_VALUES } from "../../stubs/shared/constants/routingStrategies";
...
export const getComboMetricsTool = {
...
export const checkQuotaInput = z.object({
  provider: z.string().optional().describe("Filter by provider name (e.g., 'claude', 'gemini'). If omitted, returns all providers."),
...
export const listModelsCatalogTool = {
...
export const webSearchInput = z.object({
  ...
  provider: z.enum(["serper-search", "brave-search", "perplexity-search", "exa-search", "tavily-search", "google-pse-search", "linkup-search", "searchapi-search", "searxng-search"]).optional().describe("Specific search provider to use")
});
...
export const webFetchInput = z.object({
  ...
  }).min(1, "URL is required").describe("The URL to fetch content from"),
  provider: z.enum(["firecrawl", "jina-reader", "tavily-search"]).optional().describe("Specific fetch provider to use (default: first available)"),
...
export const simulateRouteOutput = z.object({
  simulatedPath: z.array(z.object({
    provider: z.string(),
    model: z.string(),
...
export const simulateRouteTool = {
...
export const setBudgetGuardTool = {
...
export const setRoutingStrategyTool = {
...
export const setResilienceProfileTool = {
...
export const getProviderMetricsTool = {
...
export const bestComboForTaskTool = {
...
export const explainRouteOutput = z.object({
  ...
  decision: z.object({
    ...
    fallbacksTriggered: z.array(z.object({
      provider: z.string(),
      reason: z.string()
    })),
    costActual: z.number(),
...
export const getSessionSnapshotTool = {
...
export const dbHealthCheckOutput = z.object({
  ...
  issues: z.array(z.object({
    type: z.enum(["integrity_check_failed", "broken_reference", "stale_snapshot", "invalid_state"]),
    table: z.string(),
...
export const dbHealthCheckTool = {
...
export const compressionStatusOutput = z.object({
  ...
  analytics: z.object({
    ...
    byMode: z.record(z.string(), z.object({
      count: z.number(),
      tokensSaved: z.number(),
...
export const compressionStatusTool = {
...
export const compressionConfigureTool = {
...
export const setCompressionEngineTool = {
...
export const listCompressionCombosTool = {
...
export const compressionComboStatsTool = {
...
export const oneproxyFetchTool = {
...
export const oneproxyRotateTool = {
...
export const oneproxyStatsTool = {
...
export const agentSkillsListTool = {
...
export const agentSkillsGetTool = {
...
export const agentSkillsCoverageTool = {
...
export { toolSearchInput, toolSearchOutput, toolSearchTool } from "./toolSearch";
export const MCP_TOOLS = [toolSearchTool, getHealthTool, listCombosTool, getComboMetricsTool, switchComboTool, checkQuotaTool, routeRequestTool, costReportTool, listModelsCatalogTool, webSearchTool, webFetchTool, simulateRouteTool, setBudgetGuardTool, setRoutingStrategyTool, setResilienceProfileTool, testComboTool, getProviderMetricsTool, bestComboForTaskTool, explainRouteTool, getSessionSnapshotTool, dbHealthCheckTool, syncPricingTool, cacheStatsTool, cacheFlushTool, compressionStatusTool, compressionConfigureTool, setCompressionEngineTool, listCompressionCombosTool, compressionComboStatsTool, oneproxyFetchTool, oneproxyRotateTool, oneproxyStatsTool, agentSkillsListTool, agentSkillsGetTool, agentSkillsCoverageTool];
...
export const MCP_TOOL_MAP = Object.fromEntries(MCP_TOOLS.map(t => [t.name, t]));