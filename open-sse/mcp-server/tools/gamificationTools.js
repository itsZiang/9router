...
export const gamificationTools = [{
  ...
  handler: async args => {
    const {
      getTopN
    } = await import("../../stubs/lib/gamification/leaderboard");
  ...
  handler: async args => {
    const {
      getXp,
      getBadges
    } = await import("../../stubs/lib/db/gamification");
    const {
      calculateLevel,
      getLevelTitle,
      getLevelTier
    } = await import("../../stubs/lib/gamification/xp");
    const {
      getStreak
    } = await import("../../stubs/lib/gamification/streaks");
  ...
  handler: async args => {
    const {
      transferTokens
    } = await import("../../stubs/lib/gamification/sharing");
    const result = await transferTokens(args.fromApiKeyId, args.toApiKeyId, args.amount, args.reason);
    return result;
  }
}, {
  ...
  handler: async args => {
    const {
      createInvite
    } = await import("../../stubs/lib/gamification/invites");
  ...
  handler: async () => {
    const {
      listServers
    } = await import("../../stubs/lib/gamification/servers");
    return {
  ...
  handler: async () => {
    const {
      getAnomalies
    } = await import("../../stubs/lib/gamification/antiCheat");
    return {
