...
import { getBrowserPoolMetrics } from "../../services/browserPool";
 ...
 */
export async function handlePoolStatus(args) {
  if (args.provider) {
    const stats = PoolRegistry.getStats(args.provider);
    if (!stats) {
      return {
        error: `No pool found for provider '${args.provider}'`
      };
    }
    return {
 ...
 */
export async function handlePoolSessions(args) {
 ...
 */
export async function handlePoolReset(args) {
 ...
 */
export async function handlePoolWarm(args) {
...
export async function handlePoolHealth(args) {
 ...
 */
export async function handleBrowserPoolStatus() {
