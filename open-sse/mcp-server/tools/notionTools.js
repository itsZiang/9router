import { z } from "zod";
import { createNotionClient } from "../../stubs/lib/notion/api";
import { getNotionToken } from "../../stubs/lib/db/notion";
...
export const notionTools = [{
  ...
  handler: async args => {
    const client = createNotionClient(requireToken());
    return client.queryDatabase(args.databaseId, args.filter, args.sorts, args.startCursor, args.pageSize);
  }
}, {
