import { z } from "zod";
import { getCatalog, getSkillById, filterCatalog, computeCoverage, fetchSkillMarkdown } from "../../stubs/lib/agentSkills/catalog";
// ── Input Schemas ────────────────────────────────────────────────────────────
...
export const agentSkillTools = {
  omniroute_agent_skills_list: {
    ...
    handler: async args => {
      const skills = args.category || args.area ? filterCatalog({
