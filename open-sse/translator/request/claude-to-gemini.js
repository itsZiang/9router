...
import { DEFAULT_SAFETY_SETTINGS, tryParseJSON } from "../helpers/geminiHelper";
import { buildGeminiTools, sanitizeGeminiToolName } from "../helpers/geminiToolsSanitizer";
import { capMaxOutputTokens, capThinkingBudget } from "../../stubs/lib/modelCapabilities";
...
export function claudeToGeminiRequest(model, body, stream, credentials = null) {
  ...
  const changedToolNameMap = new Map([...toolNameMap.entries()].filter(([sanitizedName, originalName]) => sanitizedName !== originalName));
