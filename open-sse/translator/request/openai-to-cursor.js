  ...
  for (let i = 0; i < messages.length; i++) {
    ...
    if (msg.role === "user" || msg.role === "assistant") {
      ...
      if (msg.role === "assistant" && msg.tool_calls && msg.tool_calls.length > 0) {
        ...
        const extractedToolCalls = msg.content.filter(b => b?.type === "tool_use").map(b => ({
          id: b.id || "",
          type: "function",
          function: {
            name: b.name || "tool",
