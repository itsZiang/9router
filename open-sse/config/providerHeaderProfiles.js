...
export const KIRO_STREAMING_TARGET = "AmazonCodeWhispererStreamingService.GenerateAssistantResponse";
export const CURSOR_REGISTRY_VERSION = "3.9";
export function getGitHubCopilotChatHeaders(accept = "application/json", initiator = GITHUB_COPILOT_DEFAULT_INITIATOR) {
  return {
...
export function getQwenCliUserAgent(version = QWEN_CLI_VERSION) {
...
export function getGitHubCopilotInternalUserHeaders(authorization) {
  return {
...
export function getGitHubCopilotRefreshHeaders(authorization) {
  return {
    Authorization: authorization,
    Accept: "application/json",
...
export function getQwenOauthHeaders() {
...
export function getQoderDefaultHeaders() {
  return {
...
export function getKiroServiceHeaders(accept = "application/vnd.amazon.eventstream") {
  return {
    "Content-Type": "application/json",
    Accept: accept,
...
export function getCursorUserAgent(version) {
  return `Cursor/${version}`;
}
export function getCursorRegistryHeaders(version = CURSOR_REGISTRY_VERSION) {
  return {
