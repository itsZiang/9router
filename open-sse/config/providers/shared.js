...
import { ANTHROPIC_BETA_API_KEY, ANTHROPIC_BETA_CLAUDE_OAUTH, ANTHROPIC_VERSION_HEADER, CLAUDE_CLI_STAINLESS_PACKAGE_VERSION, CLAUDE_CLI_STAINLESS_RUNTIME_VERSION, CLAUDE_CLI_USER_AGENT } from "../anthropicHeaders";
import { getCodexDefaultHeaders } from "../codexClient";
import { GLM_REQUEST_DEFAULTS, GLMT_REQUEST_DEFAULTS, GLM_TIMEOUT_MS, GLMT_TIMEOUT_MS, GLM_SHARED_MODELS } from "../glmProvider";
import { MARITALK_DEFAULT_BASE_URL } from "../maritalk";
import { CURSOR_REGISTRY_VERSION, getAntigravityProviderHeaders, getCursorRegistryHeaders, getGitHubCopilotChatHeaders, getKiroServiceHeaders, getQoderDefaultHeaders, getQwenOauthHeaders, getRuntimePlatform, getRuntimeArch } from "../providerHeaderProfiles";
import { resolvePublicCred } from "../../utils/publicCreds";
import { buildGitLabOAuthEndpoints, GITLAB_DUO_DEFAULT_BASE_URL } from "../../stubs/lib/oauth/gitlab";
...
export const REASONING_UNSUPPORTED = Object.freeze(["temperature", "top_p", "frequency_penalty", "presence_penalty", "logprobs", "top_logprobs", "n"]);
/**
...
export const buildModels = ids => ids.map(id => ({
  id,
  name: id
}));
export const ALIBABA_DASHSCOPE_MODELS = [{
  id: "qwen-max",
  name: "Qwen Max"
}, {
...
export const CHAT_OPENAI_COMPAT_MODELS = {
  deepinfra: buildModels(["anthropic/claude-4-opus", "anthropic/claude-4-sonnet", "openai/gpt-oss-120b", "openai/gpt-oss-20b", "google/gemma-4-31B-it", "google/gemma-4-26B-A4B-it", "nvidia/NVIDIA-Nemotron-3-Super-120B-A12B", "nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning", "meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8", "meta-llama/Llama-4-Scout-17B-16E-Instruct", "meta-llama/Llama-3.3-70B-Instruct-Turbo", "NousResearch/Hermes-3-Llama-3.1-405B", "deepseek-ai/DeepSeek-V4-Pro", "deepseek-ai/DeepSeek-V4-Flash", "zai-org/GLM-5.1", "moonshotai/Kimi-K2.6", "MiniMaxAI/MiniMax-M2.5", "Qwen/Qwen3.6-35B-A3B", "Qwen/Qwen3.5-397B-A17B", "Qwen/Qwen3.5-122B-A10B", "XiaomiMiMo/MiMo-V2.5-Pro", "XiaomiMiMo/MiMo-V2.5"]),
  "vercel-ai-gateway": buildModels(["openai/gpt-4.1", "anthropic/claude-4-sonnet", "google/gemini-2.5-pro", "moonshotai/kimi-k2", "vercel/v0-1.5-md"]),
  "lambda-ai": buildModels(["deepseek-r1-671b", "llama3.3-70b-instruct-fp8", "qwen25-coder-32b-instruct"]),
  sambanova: buildModels(["MiniMax-M2.7", "DeepSeek-V3.2", "Llama-4-Maverick-17B-128E-Instruct", "Meta-Llama-3.3-70B-Instruct", "gpt-oss-120b"]),
  nscale: buildModels(["moonshotai/Kimi-K2.5", "Qwen/Qwen3-235B-A22B-Instruct-2507", "openai/gpt-oss-120b", "openai/gpt-oss-20b", "meta-llama/Llama-4-Scout-17B-16E-Instruct", "meta-llama/Llama-3.3-70B-Instruct"]),
  ovhcloud: buildModels(["Meta-Llama-3_3-70B-Instruct", "Qwen2.5-Coder-32B-Instruct", "Mistral-Small-3.2-24B-Instruct-2506"]),
  baseten: buildModels(["moonshotai/Kimi-K2.6", "deepseek-ai/DeepSeek-V4-Pro", "zai-org/GLM-5", "MiniMaxAI/MiniMax-M2.5", "nvidia/Nemotron-120B-A12B", "openai/gpt-oss-120b"]),
  publicai: buildModels(["swiss-ai/apertus-70b-instruct", "swiss-ai/Apertus-8B-Instruct-2509", "aisingapore/Qwen-SEA-LION-v4-32B-IT", "aisingapore/Gemma-SEA-LION-v4-27B-IT", "allenai/Olmo-3-32B-Think", "allenai/Olmo-3-7B-Instruct", "utter-project/EuroLLM-22B-Instruct-2512"]),
  moonshot: [...buildModels(["kimi-k2.6", "kimi-k2.5"]), ...KIMI_K27_MODELS],
  "meta-llama": buildModels(["Llama-4-Maverick-17B-128E-Instruct-FP8", "Llama-4-Scout-17B-16E-Instruct-FP8", "Llama-3.3-70B-Instruct", "Llama-3.3-8B-Instruct"]),
  ...
  heroku: buildModels(["claude-opus-4-7", "claude-4-6-sonnet", "claude-4-5-haiku", "glm-4-7", "kimi-k2-5", "minimax-m2-1", "deepseek-v3-2", "qwen3-coder-480b", "qwen3-235b", "gpt-oss-120b", "nova-pro", "nova-2-lite"]),
  galadriel: buildModels(["galadriel-latest"]),
  databricks: buildModels(["databricks-gpt-5", "databricks-meta-llama-3-3-70b-instruct", "databricks-claude-sonnet-4", "databricks-gemini-2-5-pro"]),
  snowflake: buildModels(["llama3.1-70b", "llama3.3-70b", "deepseek-r1", "claude-3-5-sonnet"]),
  wandb: buildModels(["openai/gpt-oss-120b", "Qwen/Qwen3-Coder-480B-A35B-Instruct", "deepseek-ai/DeepSeek-V3.1"]),
  volcengine: buildModels(["deepseek-v3-2-251201", "doubao-seed-2-0-pro-260215", "doubao-seed-2-0-code-preview-260215",
  // Sweep 2026-06-19: kimi-k2-thinking-251104 retired on Ark (volcengine official
  // notices); replaced by kimi-k2-5-260127.
  "kimi-k2-5-260127", "glm-4-7-251222",
  ...
  "inference-net": buildModels(["meta-llama/Llama-3.3-70B-Instruct", "deepseek-ai/DeepSeek-R1", "Qwen/Qwen2.5-72B-Instruct"]),
  nanogpt: buildModels(["chatgpt-4o-latest", "claude-3.5-sonnet", "gpt-4o-mini"]),
  predibase: buildModels(["llama-3.3-70b"]),
  bytez: buildModels(["meta-llama/Llama-3.3-70B-Instruct", "mistralai/Mistral-7B-Instruct-v0.3", "Qwen/Qwen2.5-72B-Instruct"]),
...
export { ANTIGRAVITY_BASE_URLS, ANTIGRAVITY_PUBLIC_MODELS, AGY_PUBLIC_MODELS, ANTHROPIC_BETA_API_KEY, ANTHROPIC_BETA_CLAUDE_OAUTH, ANTHROPIC_VERSION_HEADER, CLAUDE_CLI_STAINLESS_PACKAGE_VERSION, CLAUDE_CLI_STAINLESS_RUNTIME_VERSION, CLAUDE_CLI_USER_AGENT, getCodexDefaultHeaders, GLM_REQUEST_DEFAULTS, GLMT_REQUEST_DEFAULTS, GLM_TIMEOUT_MS, GLMT_TIMEOUT_MS, GLM_SHARED_MODELS, MARITALK_DEFAULT_BASE_URL, CURSOR_REGISTRY_VERSION, getAntigravityProviderHeaders, getCursorRegistryHeaders, getGitHubCopilotChatHeaders, getKiroServiceHeaders, getQoderDefaultHeaders, getQwenOauthHeaders, getRuntimePlatform, getRuntimeArch, resolvePublicCred, buildGitLabOAuthEndpoints, GITLAB_DUO_DEFAULT_BASE_URL };
export function getClaudeCliHeaders() {
  return {
    "Anthropic-Version": ANTHROPIC_VERSION_HEADER,
...
export function getAnthropicCompatHeaders() {
  return {
    "Anthropic-Version": ANTHROPIC_VERSION_HEADER
  };
}
export function buildAntigravityUrl(base, model, stream) {
