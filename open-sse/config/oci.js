...
export const OCI_DEFAULT_BASE_URL = "https://inference.generativeai.us-chicago-1.oci.oraclecloud.com/openai/v1";
export function normalizeOciBaseUrl(value) {
...
export function buildOciChatUrl(value, apiType = "chat") {
  return `${normalizeOciBaseUrl(value)}/${apiType === "responses" ? "responses" : "chat/completions"}`;
}
export function buildOciModelsUrl(value) {
