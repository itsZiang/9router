...
export function buildBedrockNativeInferenceProfilesUrl(region, options = {}) {
...
export function normalizeBedrockDiscoveredModels(foundationModelsResponse, inferenceProfilesResponse = null) {
  const byId = new Map();
  const add = model => {
